...
#
# Comprehensive test runner for debug-tests directory
...
run_test_script() {
    ...
    echo -e "${CYAN}========================================${NC}"
    echo -e "${CYAN}Running debug test: $script_name${NC}"
    echo -e "${CYAN}========================================${NC}"
...
display_summary() {
    echo -e "${CYAN}========================================${NC}"
    echo -e "${CYAN}Debug Tests Summary${NC}"
    echo -e "${CYAN}========================================${NC}"
    echo ""
    ...
    if [[ $TOTAL_FAILED -eq 0 ]]; then
        echo -e "${GREEN}🎉 All debug tests passed successfully!${NC}"
        echo ""
        echo "All debug functionality is working correctly."
    else
        echo -e "${RED}❌ Some debug tests failed${NC}"
        echo ""
...
main() {
    echo -e "${CYAN}========================================${NC}"
    echo -e "${CYAN}next-version Debug Test Suite${NC}"
    echo -e "${CYAN}========================================${NC}"
    echo ""
    echo "This test suite validates debug functionality in the next-version project."
    echo ""
    
    # Check dependencies
    check_dependencies
    
    echo -e "${BLUE}Starting debug test execution...${NC}"
    echo ""
