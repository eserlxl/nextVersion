...
main() {
    ...
    run_test "mathematical-version-bump --help" "\"$DEV_BIN/mathematical-version-bump.sh\" --help" "Mathematical Version Bumper for next-version"
    run_test "tag-manager help" "\"$DEV_BIN/tag-manager.sh\"" "Tag Manager for next-version"
